...
- Http协议属于应用层，及用户访问的第一层就是http
  ...
  ![在这里插入图片描述](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="550" height="226"></svg>)
...
参考链接：https://juejin.im/post/6844904125692379143
